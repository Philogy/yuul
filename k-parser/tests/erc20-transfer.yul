...
object "ERC20_39" {
    code {
        ...
        function cleanup_t_rational_1000000000000000000000_by_1(value) -> cleaned {
            cleaned := value
        }
        ...
        function convert_t_rational_1000000000000000000000_by_1_to_t_uint256(value) -> converted {
            converted := cleanup_t_uint256(identity(cleanup_t_rational_1000000000000000000000_by_1(value)))
        }
        ...
        /// @ast-id 17
        /// @src 0:178:241  "constructor() {..."
        function constructor_ERC20_39() {

            /// @src 0:178:241  "constructor() {..."

            /// @src 0:227:234  "1000e18"
            let expr_13 := 0x3635c9adc5dea00000
            /// @src 0:202:234  "balanceOf[msg.sender] += 1000e18"
            let _2 := convert_t_rational_1000000000000000000000_by_1_to_t_uint256(expr_13)
    ...
    object "ERC20_39_deployed" {
        code {
            ...
            /// @ast-id 38
            /// @src 0:247:383  "function transfer(address to, uint256 amount) external {..."
            function fun_transfer_38(var_to_19, var_amount_21) {

                /// @src 0:337:343  "amount"
                let _1 := var_amount_21
                let expr_28 := _1
                /// @src 0:312:321  "balanceOf"
                let _2_slot := 0x00
                let expr_24_slot := _2_slot
                /// @src 0:322:332  "msg.sender"
                let expr_26 := caller()
                /// @src 0:312:333  "balanceOf[msg.sender]"
                let _3 := mapping_index_access_t_mapping$_t_address_$_t_uint256_$_of_t_address(expr_24_slot,expr_26)
                /// @src 0:312:343  "balanceOf[msg.sender] -= amount"
...
contract "ERC20_1" "ERC20_39_deployed"

"ERC20_1" :: 0x70a082310000000000000000000000000000000000000000
